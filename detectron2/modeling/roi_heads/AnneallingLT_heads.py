...
class ROIHeads(torch.nn.Module):
    ...
    def _sample_proposals(
        self, matched_idxs: torch.Tensor, matched_labels: torch.Tensor, gt_classes: torch.Tensor, ori_classes: torch.Tensor, 
        ...
        if has_gt:
            ...
            ori_classes = ori_classes[matched_idxs]  ##
            ori_classes[matched_labels == 0] = self.num_classes
            ori_classes[matched_labels == -1] = -1

        else:
            gt_classes = torch.zeros_like(matched_idxs) + self.num_classes
            ori_classes = gt_classes
        ...
        ori_classes_ss = ori_classes[sampled_idxs]
        ...
        if self.enable_thresold_autolabelling:
            ...
            ori_classes_ss[mask] = self.num_classes - 1

        return sampled_idxs, gt_classes_ss, ori_classes_ss
    ...
    def label_and_sample_proposals(
        ...
        for proposals_per_image, targets_per_image in zip(proposals, targets):
            ...
            sampled_idxs, gt_classes, ori_classes = self._sample_proposals(
                matched_idxs, matched_labels, targets_per_image.gt_classes, targets_per_image.ori_classes, proposals_per_image.objectness_logits
            )

            # Set target attributes of the sampled proposals:
            proposals_per_image = proposals_per_image[sampled_idxs]
            proposals_per_image.gt_classes = gt_classes
            proposals_per_image.ori_classes = ori_classes
...
class Res5ROIHeads(ROIHeads):
    ...
    def __init__(self, cfg, input_shape):
        ...
        self.box_predictor = CosineSimOutputLayers(

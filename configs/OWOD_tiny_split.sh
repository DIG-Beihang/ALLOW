...
EXP_DIR=exps/OWOD_t1_tiny
PY_ARGS=${@:1}

python -u main_open_world.py --data_root './data/OWDETR' \
    --output_dir ${EXP_DIR} --dataset owod --num_queries 100 --eval_every 5 \
    --PREV_INTRODUCED_CLS 0 --CUR_INTRODUCED_CLS 19 --train_set 't1_train_tiny' --test_set 'test' --num_classes 81 \
    --epochs 50 --featdim 1024 \
    --backbone 'dino_resnet50' \
    ${PY_ARGS}

EXP_DIR=exps/OWOD_t1_tiny_extending
PY_ARGS=${@:1}
python -u main_open_world.py --data_root './data/OWDETR' \
    --output_dir ${EXP_DIR} --dataset owod --num_queries 100 --eval_every 5 \
    --PREV_INTRODUCED_CLS 0 --CUR_INTRODUCED_CLS 19 --train_set 't1_train_tiny' --test_set 'test' --num_classes 81 \
    ...
    --backbone 'dino_resnet50' \
    --pretrain 'exps/OWOD_t1_tiny/checkpoint0049.pth' \
    --cooling \
    --cooling_prev 50 \
    ${PY_ARGS}
:<<!
...
python -u main_open_world.py --data_root './data/OWDETR' \
    ...
    --unmatched_boxes --epochs 100 --lr 2e-5 --top_unk 5 --featdim 1024 --NC_branch --nc_loss_coef 0.1 --nc_epoch 9 \
    --backbone 'dino_resnet50' \
...
python -u main_open_world.py --data_root './data/OWDETR' \
    ...
    --unmatched_boxes --epochs 150 --top_unk 5 --featdim 1024 --NC_branch --nc_loss_coef 0.1 --nc_epoch 9 \
    --backbone 'dino_resnet50' \
...
python -u main_open_world.py --data_root './data/OWDETR' \
    ...
    --unmatched_boxes --epochs 250 --top_unk 5 --featdim 1024 --NC_branch --nc_loss_coef 0.1 --nc_epoch 9 \
    --backbone 'dino_resnet50' \
...
python -u main_open_world.py --data_root './data/OWDETR' \
    ...
    --unmatched_boxes --epochs 300 --lr 2e-5 --top_unk 5 --featdim 1024 --NC_branch --nc_loss_coef 0.1 --nc_epoch 9 \
    --backbone 'dino_resnet50' \
